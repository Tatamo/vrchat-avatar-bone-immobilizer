...
- Fix conflicts when multiple ImmobilizeBones components reference the same bone.
...
- `CaptureEuler` and `CaptureAllEuler` are also exported from ImmobilizeBones class.
